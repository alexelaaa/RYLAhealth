...
export const FRIDAY_DETAILED: DetailedEvent[] = [
  ...
  { time: "12:45 – 1:45", title: "Lunch", location: "Dining Hall", note: "Eat with your group" },
  { time: "2:00 – 2:45", title: "Activity 1", location: "Activity Areas", bold: true },
  { time: "3:00 – 3:15", title: "Rules Discussion", location: "Main Amphitheater" },
  { time: "3:20 – 3:25", title: "Camp Photo", location: "Main Amphitheater" },
  { time: "3:30 – 4:30", title: "Ice Breakers", location: "Emerson Field", note: "Max Dutton & Jackie G." },
